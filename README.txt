...
-----------------------------------------------------------------------------
Web site: https://borsboom.io/current-atlas-tables/
...
There is a Dockerfile for an environment with the correct configuration and
tools installed.  The image is also uploaded to Docker Hub at
